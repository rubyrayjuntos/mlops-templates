...
try {  
    ...
    var enable_aml_computecluster = String(configYaml["variables"]["enable_aml_computecluster"]) === "true";
    var enable_monitoring = String(configYaml["variables"]["enable_monitoring"]) === "true";
